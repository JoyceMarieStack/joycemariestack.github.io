...
[One to two sentences on your focus — e.g., docs-as-code, developer experience, AI-assisted documentation.]

---

## Writing

- **[For Developers Who Want Fewer Interruptions](docs/for-devs-who-want-fewer-interruptions)** — Write docs that deflect Slack questions, and beat the "Docs Feedback Loop of Doom."
- **[Getting Started with Docs as Code](docs/getting-started-with-docs-as-code)** — A practical starting point for teams that feel stuck moving off Confluence and into Markdown.
